...
${OPEN_REGISTER}  xpath=//a[text()='Register']
...
Register User
    ...
    Wait Until Element Is Enabled    ${OPEN_REGISTER}
    Click Element    ${OPEN_REGISTER}
    ...
    Wait Until Element Is Enabled    ${REGISTER_BUTTON}
